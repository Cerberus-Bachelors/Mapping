...
def add_nvblox(args: lu.ArgumentContainer) -> List[Action]:
    ...
    base_config = lu.get_path('mapping_bringup', 'config/nvblox/nvblox_base.yaml')
    segmentation_config = lu.get_path('mapping_bringup',
                                      'config/nvblox/specializations/nvblox_segmentation.yaml')
    detection_config = lu.get_path('mapping_bringup',
                                   'config/nvblox/specializations/nvblox_detection.yaml')
    dynamics_config = lu.get_path('mapping_bringup',
                                  'config/nvblox/specializations/nvblox_dynamics.yaml')
    isaac_sim_config = lu.get_path('mapping_bringup',
                                   'config/nvblox/specializations/nvblox_sim.yaml')
    realsense_config = lu.get_path('mapping_bringup',
                                   'config/nvblox/specializations/nvblox_realsense.yaml')
    multi_realsense_config = lu.get_path(
        'mapping_bringup', 'config/nvblox/specializations/nvblox_multi_realsense.yaml')
    zed_config = lu.get_path('mapping_bringup',
