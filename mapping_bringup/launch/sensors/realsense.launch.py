...
EMITTER_FLASHING_CONFIG_FILE_PATH = lu.get_path('mapping_bringup', 'config/sensors/realsense_emitter_flashing.yaml')
EMITTER_ON_CONFIG_FILE_PATH = lu.get_path('mapping_bringup', 'config/sensors/realsense_emitter_on.yaml')
